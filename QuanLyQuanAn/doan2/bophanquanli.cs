    ...
    public partial class bophanquanli : Form
    {
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            if (dgvChiNhanh.SelectedRows.Count > 0)
            {
                ...
                cn["MaChiNhanh"] = tbMaChiNhanh.Text;
...
;            }
        ...
        private void tbMaCN_TextChanged_1(object sender, EventArgs e)
        {

        }

        private void tbTenChiNhanh_TextChanged(object sender, EventArgs e)
        {
...
;
        ...
        private void tbTimKiemChiNhanh_TextChanged(object sender, EventArgs e)
        {
            if (tbTimKiemChiNhanh.Text == "")
            {
                dsChiNhanhView.RowFilter = "";
